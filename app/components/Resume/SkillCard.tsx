...
const SkillCard: React.FC<SkillCardProps> = ({ title, skills, className = '' }) => {
  return (
    <div className={`shadow-slate-300 shadow-lg border border-slate-200 bg-white p-5 md:p-12 rounded-xl w-full ${className}`}>
      <h2 className="text-xl md:text-3xl font-semibold gradient-text mb-6">{title}</h2>
